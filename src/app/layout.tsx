      ...
      <html lang="en">
        <body>
          ...
          <ul className="flex items-center pr-5">
              <li>
              <SideTrigger size={25} onClickTrigger={()=>{sidebarOpen? setSidebarOpen(false): setSidebarOpen(true)}}/>
              </li>
          </ul>
          <ul className="flex items-center">
              <li>
                  <h1 className="pl-8 lg:pl-0 text-gray-700">Pokemon Info</h1>
              </li>
          </ul>
          </Navbar>
