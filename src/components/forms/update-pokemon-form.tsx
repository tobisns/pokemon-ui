...
import { create_pokemon, update_pokemon } from '../../services/crud';
...
export const UpdatePokemonForm = (props: PropsWithChildren<UpdatePokemonProps>) => {
    const {initialValues, pokemon} = props;
    return (
        <>
            <Formik 
                ...
                onSubmit={async (values) => {
                    try {
                        const res = await update_pokemon(pokemon, values);
                        console.log(res)
                        if(res) {
                    ...
                    <Form className="flex flex-col gap-2 p-5 w-full">
                        ...
                        <div className="flex flex-col mb-3">
                            ...
                            <Field type="text" name="name" placeholder="Name" id="name"
                                    className=" read-only sub-1 rounded px-2 py-1 border border-black bg-white text-black"
                                    readOnly />
                        </div>
                        <div className="flex flex-col mb-3">
